...
function getData(){
    ...
    for (var i=0;i<zodiacs.length;i++) {
    	if (userSearch === zodiacs[i].name.toLowerCase()){
              ...
              document.getElementById('img-result').src = zodiacs[i].image;
              document.getElementById('name-result').innerHTML = zodiacs[i].name ;
              document.getElementById('date-result').innerHTML = zodiacs[i].month ;
